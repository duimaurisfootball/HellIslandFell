...
{
    public class PerformEffectWithSpecificStatusEffectApplicationFalseSetterWearable : BaseWearableSO
    {
        ...
        {
            if (args is StatusFieldApplication statusFieldApplication && !statusFieldApplication.Equals(null) && _statusEffects.Contains(statusFieldApplication.statusID))
            {
