...
namespace Hell_Island_Fell.Fools
{
    public class Hills
    {
        public static void Add()
        {
            ...
            //mania
            Ability mania0 = new Ability("Rolling Mania", "Mania_1_A")
            {
            ...
            Ability mania1 = new Ability("Twisting Mania", "Mania_2_A")
            {
            ...
            Ability mania2 = new Ability("Spiraling Mania", "Mania_3_A")
            {
            ...
            Ability mania3 = new Ability("Endless Mania", "Mania_4_A")
            {
            ...
            //a shatter
            Ability shatter0 = new Ability("A Stupid Shatter", "AShatter_1_A")
            {
            ...
            hills.AddLevelData(12, new Ability[] { mania0, bellow0, shatter0 });
            hills.AddLevelData(17, new Ability[] { mania1, bellow1, shatter1 });
            hills.AddLevelData(22, new Ability[] { mania2, bellow2, shatter2 });
            hills.AddLevelData(27, new Ability[] { mania3, bellow3, shatter3 });
