...
namespace Hell_Island_Fell.Encounters
{
    public class HeehooEncounters
    {
        public static void Add()
        {
            ...
            {
                MusicEvent = "event:/Music/DLC_01/Mx_InnerChildren_141",
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector("H_Zone02_Heehoo_Medium_EnemyBundle", 15, ZoneType_GameIDs.Orpheum_Hard, BundleDifficulty.Medium);
            ...
            EnemyEncounterUtils.AddEncounterToZoneSelector("H_Zone02_Heehoo_Hard_EnemyBundle", 10, ZoneType_GameIDs.Orpheum_Hard, BundleDifficulty.Hard);
        }
    }
}
